# File: pizza_panic.py
# Version 1.1.0:
#   + Add difficulty, pizzas speed up after 100 points
#   + Add new face on chef
# About: Player must catch falling pizzas before they hit the ground'
...
class Pizza(games.Sprite):
    ...
    speed = 1
    difficulty = 0  # Counter for increasing difficulty
